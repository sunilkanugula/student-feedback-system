...
onClickBack = () => this.setState({ department: branchList[0],
  semester: "1-1",
  academicYear: "2024-2025",
  no_subjects: 0,
  subjectsBasedOnInput: [],
  ...
  render() {
    const {feedback, subjectsBasedOnInput, facultyNames, showTablePage ,clicked, clickedIndex,semester,department,section,totalSubmissions,feedbackList} = this.state;
    console.log(feedbackList,"hii")
    return (
      <div className="hod-bg-container">
        ...
        {!showTablePage ? (
          <form className="principal-form" onSubmit={this.displayFacultyAndSubjects}>
            <h1 style={{ textAlign: 'center', color: '#074173' }}>Check Feedback Review</h1>
          ...
          <div className="principal-faculty-result-container">
            ...
            <h4 style={{  height:"20px", margin:"0px" ,marginBottom:"2px"}}>Acadamic Year : {this.state.academicYear}</h4>
      ...
      <button type="button"
              className="back-btn" onClick={this.onClickBack}>Back</button>
      </div>
