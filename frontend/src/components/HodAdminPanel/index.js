...
const HodAdminPanel = () => {
  ...
  const [subjectType, setSubjectType] = useState("Theoretical"); // Added state for subject type
  ...
  const onChangeSubjectType = (e) => setSubjectType(e.target.value); // Added change handler for subject type
  ...
  const handleSubmit = async (e) => {
    ...
    ) 
    {
      const formData = {
        ...
        section,
        feedback,
        subjectType, // Added subjectType to formData
      };

      try {
        const response = await fetch("http://192.168.210.96/saveFormData", {
          method: "POST",
          headers: {
      ...
      <div className="hod-bg-container">
        ...
        <div className="hod-form-bg-container">
          <form className="hod-form" onSubmit={handleSubmit}>
            ...
            <div className="hod-input-take-container">
              <label htmlFor="feedbackAttempt">Feedback Attempt</label>
              <select
                className="hod-input"
                id="feedbackAttempt"
