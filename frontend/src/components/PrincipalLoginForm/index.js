...
class PrincipalLoginForm extends Component {
  ...
  submitForm = async (event) => {
    ...
    const url = 'https://student-feedback-system-8ln5.onrender.com/principal-login';
    const options = {
      method: 'POST',
  ...
  render() {
    const { showSubmitError, errorMsg, shouldNavigateToPrincipal, shouldNavigateToRegister,backToHome } = this.state;
